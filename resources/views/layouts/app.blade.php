...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/home/css/bootstrap.min.css') }}">                                      <!-- Bootstrap style -->
    <link rel="stylesheet" href="{{ asset('css/home/css/templatemo-style.css') }}">                                   <!-- Templatemo style -->
...
<body>
    <div id="apdp">
        ...
        <div class="tm-header">
            <div class="container-fluid">
                <div class="tm-header-inner">
                    <a href="/" class="navbar-brand tm-site-name">Medium</a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12 tm-copyright-col">
                        <p class="tm-copyright-text">Copyright 2022 Your Company Name</p>
                    </div>
                </div>
            </div>
        </footer>
     ...
     <!-- load JS files -->
        <script src="{{ asset('js/home/js/jquery-1.11.3.min.js') }}"></script>             <!-- jQuery (https://jquery.com/download/) -->
        <script src="https://www.atlasestateagents.co.uk/javascript/tether.min.js"></script> <!-- Tether for Bootstrap, http://stackoverflow.com/questions/34567939/how-to-fix-the-error-error-bootstrap-tooltips-require-tether-http-github-h --> 
        <script src="{{ asset('js/home/js/bootstrap.min.js') }}"></script>                 <!-- Bootstrap (http://v4-alpha.getbootstrap.com/) -->
</body>
</html>
